    ...
    rows: [
      {
        ...
        shownBy: { label: "500 cUSDC in", tx: "0xf6fbd169e117cefda236d71c4e0e827d01ea769f42ff70eee88eb48ecda01109" },
        kind: "met",
      },
      {
        need: "Draw",
        ...
        shownBy: { label: "draw 35 revealed", tx: "0x3f804883b402eb1ed6b27800a06518a3a822fec20fb5dbada76cf6aa6e62d499" },
        kind: "met",
      },
      {
        need: "Claim",
        ...
        shownBy: { label: "moved exactly 1.000000 cUSDC", tx: "0x42743cf9421110ad11a8a81c783d1926bc2a2fbc62907d409510ba776eb7e3e0" },
        kind: "met",
        note: "The first claim we ran succeeded while doing nothing — `deposit` had already drained the credit. It is not counted. This one is the second attempt, run after winning draw 35, and it moved the position from 12,290 to 12,291.",
      },
      {
        need: "Withdraw",
        ...
        shownBy: { label: "250 out, balanced to the unit", tx: "0x2d7ded28c6ec1e23cef248754b0c9321a996108813e9ea3d0ee7295dea410c0b" },
        kind: "limited",
        note: "All-or-nothing: asking for more than you hold, or more than the pool has liquid, moves nothing and still succeeds. A confidential token cannot revert on an insufficient balance without leaking the comparison.",
      },
      {
        ...
        shownBy: { label: "fresh wallet deposits", tx: "0xda54ff98d06224cd5dc8a19ac9111eb61d04a132bb8286c78aa2bb7b9fd2df00" },
        kind: "met",
    ...
    rows: [
      {
        ...
        shownBy: { label: "R revealed with a KMS proof", tx: "0xcc6712d72a35142539bfce0a2ee0b4a708ba7adb75f8474ed72d8bbd91503e97" },
        kind: "met",
